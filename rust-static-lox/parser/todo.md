...
- [ ] Define Token enum with all Rust tokens
  ```rust
  enum Token {
    // Keywords
...
- [ ] Implement literal tokenization
  - [ ] Integer literals (decimal, hex, octal, binary)
  - [ ] Float literals
  - [ ] String literals with escape sequences
  - [ ] Raw strings (`r#"..."#`)
  - [ ] Character literals
  - [ ] Byte literals and byte strings

- [ ] Implement lifetime tokenization (`'a`, `'static`)

- [ ] Add position tracking (line, column, byte offset)

### 1.3 Diagnostic System
- [ ] Implement `Span` structure
  ```rust
  pub struct Span {
    pub start: usize,
    pub end: usize,
...
## Phase 2: Expression Parsing (Week 3-4)
